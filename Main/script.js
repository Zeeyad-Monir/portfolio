/* ==========================
 ...
 /* ==========================
   MOBILE NAVIGATION - FIXED FOR IPHONE
   ========================== */
document.addEventListener('DOMContentLoaded', () => {
  const cursor = document.querySelector('.cursor');
  if (cursor) {
  ...
  function initMobileNavigation() {
    ...
    console.log("Found menu elements, attaching events"); // Debug log
    ...
    function toggleMenu(e) {
      ...
      console.log("Menu active state:", menuButton.classList.contains('active')); // Debug log
    ...
    mobileNavLinks.forEach(link => {
      function closeMenu(e) {
        console.log("Close menu from link click"); // Debug log
    ...
    // Create a direct click handler for testing
    window.toggleMobileMenu = function() {
      console.log("Manual toggle menu called"); // Debug log
      toggleMenu();
    };
